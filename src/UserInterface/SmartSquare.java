 ...
 * This class implements the methods from ActionListener and MouseListener to
 * respond different click events.
 * Each square has its own unique representation of coordinates and attributes.
 * This class counts the number of its surrounding bombs once user clicks the
 * square.
...
public class SmartSquare extends GameSquare implements MouseListener, TimeChecker {
    ...
    public void clicked() {
        ...
        if (thisSquareHasBomb) {
             ...
             * expanding into empty space until the surrounding of the space has at least
             * one bomb
